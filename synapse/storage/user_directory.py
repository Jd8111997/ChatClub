...
class UserDirectoryStore(SQLBaseStore):
    ...
    def update_profile_in_user_dir(self, user_id, display_name, avatar_url,dob, room_id):
        def _update_profile_in_user_dir_txn(txn):
            new_entry = self._simple_upsert_txn(
                ...
                values={"display_name": display_name, "avatar_url": avatar_url,"dob" : dob},
    ...
    def get_user_in_directory(self, user_id):
        return self._simple_select_one(
            table="user_directory",
            keyvalues={"user_id": user_id},
            retcols=("room_id", "display_name", "avatar_url", "dob"),
            allow_none=True,
    ...
    def search_user_dir(self, user_id, search_term, limit):
        ...
        if isinstance(self.database_engine, PostgresEngine):
            ...
            sql = """
                SELECT d.user_id AS user_id, display_name, avatar_url ,dob
                ...
                ORDER BY
                    ...
                    * (CASE WHEN dob IS NOT NULL THEN 1.2 ELSE 1.0 END)
                    * (
                        3 * ts_rank_cd(
                            '{0.1, 0.1, 0.9, 1.0}',
                            vector,
