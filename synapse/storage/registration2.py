...
class RegistrationWorkerStore(SQLBaseStore):
    ...
    def get_user_by_id(self, user_id):
        return self._simple_select_one(
            ...
            retcols=[
                ...
                "appservice_id", "creation_ts",'gender','dob','address','mobile_no',"place","department","branch"
            ],
            allow_none=True,
            desc="get_user_by_id",
        )
    ...
    def _query_for_auth(self, txn, token):
        sql = (
            "SELECT signup.name, signup.is_guest, access_tokens.id as token_id,"
            " access_tokens.device_id"
            " FROM signup"
            " INNER JOIN access_tokens on signup.name = access_tokens.user_id"
            " WHERE token = ?"
        )
...
class RegistrationStore(RegistrationWorkerStore,
    ...
    def register(self, user_id,token=None, password_hash=None,
                 ...
                 create_profile_with_localpart=None, admin=False,gender=None,dob=None,address=None,mobile_no=None,place=None,department=None,branch=None):
...
,,,
    ...
    def get_users_by_id_case_insensitive(self, user_id):
        ...
        def f(txn):
            sql = (
                "SELECT name, password_hash FROM signup"
    ...
    def count_all_users(self):
        ...
        def _count_users(txn):
            txn.execute("SELECT COUNT(*) AS signup FROM signup")
            rows = self.cursor_to_dict(txn)
            if rows:
    ...
    def count_nonbridged_users(self):
        def _count_users(txn):
            txn.execute("""
                SELECT COALESCE(COUNT(*), 0) FROM signup
    ...
    def find_next_generated_user_id_localpart(self):
        ...
        def _find_next_generated_user_id(txn):
            txn.execute("SELECT name FROM signup")
