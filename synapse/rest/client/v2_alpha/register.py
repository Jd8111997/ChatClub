...
class RegisterRestServlet(RestServlet):
    ...
    def on_POST(self, request):
        ...
        if registered_user_id is not None:
            ...
            # print("desired_username = ",desired_username)
            # print("guest_access_token = ",guest_access_token)
    ...
    @defer.inlineCallbacks
    def _do_shared_secret_registration(self, username, password, body, gender, dob, address, mobile_no, place,
                                       department, branch):
        ...
        (user_id, _) = yield self.registration_handler.register(
            localpart=username, password=password, gender=gender, dob=dob, address=address, mobile_no=mobile_no,
            place=place, department=department, branch=branch, generate_token=False,
        )
    ...
    def _do_guest_registration(self, params):
        ...
        #  print("gender = ",getattr("gender","gender"))
        #        gender = yield  self.registration_handler.register(gender=getattr("gender"))
