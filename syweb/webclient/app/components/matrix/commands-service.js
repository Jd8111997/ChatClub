...
.factory('commandsService', ['$q', '$location', 'matrixService', 'modelService', function($q, $location, matrixService, modelService) {
    ...
    var doroomname = function(room_id, args) {
        if (args) {
            console.log("Hey there roomId" +room_id);
            return matrixService.setName(room_id, args);                     
        }
        return reject("Usage: /roomname <room_name>");
    };
