...
var init = function(exports){
    ...
    MatrixClient.prototype = {
        ...
        joinRoom: function(roomIdOrAlias, callback) {
         ...
         //for bithdaywish--------------------------------------------------------------------
         bithdaywish: function(roomIdOrAlias, body,roomId, txnId, callback) {
            var content = {
                 msgtype: "m.text",
                 body: body
            };

            return this.sendTextMessage(roomIdOrAlias, content,roomId, txnId, callback);
            },
        //-----------------------------------------------------------------------------------
        ...
        //added by akshay
        setGroupAvatarUrl: function(roomId, url, callback) {
                return this.sendStateEvent( roomId, "m.room.avatar", {group_avatar_url : url},
                                       undefined, callback);
        },

        //added by akshay
/*        setGroupIconInfo: function(roomId, eventType, content, stateKey,
                                 callback) {
            var pathParams = {
                $roomId: roomId,
                $eventType: eventType,
...
*/
        ...
        getProfileInfo: function(userId, info,dob , callback) {
        ...
        setdob: function(dob, callback) {
            return this.setProfileInfo(
                "dob", { dob: dob }, callback
            );
        },
        ...
        ////added by aditya
        signupFlows: function(callback) {
            return this._doRequest(callback, "GET", "/signup");
        },
        ////--------------------
        ...
        //For signup purpose
        signup: function(loginType, data, callback) {
            data.type = loginType;
            return this._doAuthedRequest(
                callback, "POST", "/signup", undefined, data
            );
        },
